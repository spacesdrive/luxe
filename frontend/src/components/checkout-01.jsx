...
export function CheckoutOne() {
	...
	return (
        <div
            className="w-full max-w-6xl flex flex-col md:flex-row justify-between items-start gap-8">
            ...
            <div
                className="w-full max-w-[400px] bg-gray-50 border p-4 rounded-xl order-1 md:order-2">
